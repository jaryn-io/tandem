...
| [`2026-09-05-shiftboard`](2026-09-05-shiftboard/00-summary.md) | 5 Sep 2026 | A visual production planner from a thirteen-requirement brief: seven roles, seven findings in two correction cycles, one word from the person after the brief; 50 minutes, no flagship model | EN | [`examples/shiftboard`](../examples/shiftboard) |
...
| [`2026-09-24-fx-paper-trading`](2026-09-24-fx-paper-trading/00-summary.md) | 24 Sep 2026 | An FX paper-trading and options risk terminal on a live public feed: seven roles from four model families, nine findings closed, the main one held open by the Reviewer through four rounds until it held in a browser against live prices, and an Auditor that broke a case Security had already verified; 3h31, 255 checks | EN | [`examples/fx-paper-trading`](../examples/fx-paper-trading) |
